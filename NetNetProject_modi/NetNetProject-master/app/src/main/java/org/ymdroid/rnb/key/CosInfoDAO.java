...
public class CosInfoDAO {
    ...
    private void makeTable(){
        ...
        A.rv.add(new Review("정유", 5, "괜찮아요"));
        A.rv.add(new Review("4", 4, "딱 제 타입입니다."));
        A.rv.add(new Review("기미뇽", 4, "처음에는 좀 따가웠는데 지금은 좋네요."));
        A.rv.add(new Review("배씨", 1, "피부가 뒤집어졌어요.."));
        A.rc = new int[]{1, 3, 4};
        cosInfos.add(A);
        ...
        A.rv.add(new Review("4", 4, "딱 제 타입입니다."));
        A.rv.add(new Review("기미뇽", 4, "리뷰보고 걱정했는데 나쁘지 않네요."));
        A.rv.add(new Review("배씨", 1, "저는 별로.."));
        ...
        A.rv.add(new Review("기미뇽", 4, "비싼지름길님 저한테 파세요. 제시요"));
        A.rv.add(new Review("배씨", 4, "괜찮아요~ 피부에 잘 맞는 것 같아요."));
        ...
        A.rv.add(new Review("기미뇽", 4, "쓸만해요"));
        A.rv.add(new Review("배씨", 3, "이건 그냥 그래요."));
        ...
        A.rv.add(new Review("UserC", 4, "딱 제 타입입니다."));
        A.rv.add(new Review("기미뇽", 1, "얼굴이 쩍쩍 갈라지는 것 같아요."));
        A.rv.add(new Review("배씨", 5, "완전 맘에 들어요!"));
        A.rv.add(new Review("임유", 4, "그냥 그럭저럭 쓸만해요."));
